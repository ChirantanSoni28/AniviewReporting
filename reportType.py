...
def reporttype(report_type = input("Please enter the Report type")):
    ...
    if report_type == "Publisher Report":
        ...
        dim = "dimensions=" + dimension[0] + character[0] + dimension[3] + character[0] + dimension[4] + character[0] + \
              dimension[6] + character[0] + dimension[7] + character[1]

        met = "metrics=" + metric[0] + character[0] + metric[1] + character[0] + metric[2] + character[0] + metric[5] + \
